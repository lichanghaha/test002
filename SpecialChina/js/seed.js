...
(function (S, undefined) {
    ...
    function getDescriptorFromUserAgent(ua) {
        ...
        if (s.length > 0) {
            ...
            // 娉ㄦ剰锛�
            //  UA.shell = ie, 琛ㄧず澶栧３鏄� ie
            //  浣� UA.ie = 7, 骞朵笉浠ｈ〃澶栧３鏄� ie7, 杩樻湁鍙兘鏄� ie8 鐨勫吋瀹规ā寮�
            //  瀵逛簬 ie8 鐨勫吋瀹规ā寮忥紝杩樿閫氳繃 documentMode 鍘诲垽鏂€備絾姝ゅ涓嶈兘璁� UA.ie = 8, 鍚﹀垯
...
(function (S, undefined) {
    ...
    S.Features = {
        ...
        'isHashChangeSupported': function () {
            // ie8 鏀寔 hashchange
            // 浣� ie8 浠ヤ笂鍒囨崲娴忚鍣ㄦā寮忓埌 ie7锛堝吋瀹规ā寮忥級锛�
            // 浼氬鑷� 'onhashchange' in window === true锛屼絾鏄笉瑙﹀彂浜嬩欢
...
(function (S, undefined) {
    ...
    // oldIE 鐗规湁锛屾壘鍒板綋鍓嶆鍦ㄤ氦浜掔殑鑴氭湰锛屾牴鎹剼鏈悕纭畾妯″潡鍚�
